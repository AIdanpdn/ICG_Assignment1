Shader "Custom/AlltogehterShader"
{
    Properties
    {
    ...
    SubShader
    {
		...
		Pass
		{
			...
			vertexOutput vert(vertexInput v) 
			{
                ...
                float3 lightFinal = diffuseReflection + unity_IndirectSpecColor.xyz; //IndirectSpecColor takes the average of the skybox colours.
